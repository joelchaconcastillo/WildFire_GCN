...
from wildfire_forecasting.datamodules.datasets.greecefire_gcn_dataset import FireDataset_Graph_npy


class FireDSDataModuleGCN(LightningDataModule):
    """
    ...
    def __init__(
        ...
        self.data_train = FireDataset_Graph_npy(dataset_root=dataset_root, access_mode=self.access_mode,
        ...
        self.data_val = FireDataset_Graph_npy(dataset_root=dataset_root, access_mode=self.access_mode,
                                        problem_class=self.problem_class,
                                        train_val_test='val',
                                        dynamic_features=self.sel_dynamic_features,
                                        static_features=self.sel_static_features,
                                        categorical_features=None, nan_fill=self.nan_fill, clc=clc)
        self.data_test = FireDataset_Graph_npy(dataset_root=dataset_root, access_mode=self.access_mode,
                                         problem_class=self.problem_class,
                                         train_val_test='test',
                                         dynamic_features=self.sel_dynamic_features,
                                         static_features=self.sel_static_features,
