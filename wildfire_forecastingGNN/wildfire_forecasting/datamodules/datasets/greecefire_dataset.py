...
#        self.train_positive_list = self.train_positive_list[:32]
#        self.val_positive_list = self.val_positive_list[:32]
#        self.test_positive_list = self.test_positive_list[:32]
...
#        prev = '/home/joel.chacon/tmp/wildfire_forecastingGNN/data/'
#        for item in self.train_positive_list:
...
#                to = prev / pathlib.Path(*pto.parts[4:])
#                shutil.copyfile(filename, prev / to)
#
#        for item in self.val_positive_list:
#            p = pathlib.Path(item[0])
#            source = pathlib.Path(*p.parts[:-1])
#            name = p.stem.split('_')[:-1]
#            prefix = '_'.join(name)
...
#                shutil.copyfile(filename, prev / to)
#
#        for item in self.test_positive_list:
#            p = pathlib.Path(item[0])
#            source = pathlib.Path(*p.parts[:-1])
#            name = p.stem.split('_')[:-1]
#            prefix = '_'.join(name)
...
#                shutil.copyfile(filename, prev / to)
#
#        for item in self.train_negative_list:
#            p = pathlib.Path(item[0])
#            source = pathlib.Path(*p.parts[:-1])
#            name = p.stem.split('_')[:-1]
#            prefix = '_'.join(name)
...
#                shutil.copyfile(filename, prev / to)
#
#        for item in self.val_negative_list:
#            p = pathlib.Path(item[0])
#            source = pathlib.Path(*p.parts[:-1])
#            name = p.stem.split('_')[:-1]
#            prefix = '_'.join(name)
...
#                shutil.copyfile(filename, prev / to)
#
#        for item in self.test_negative_list:
#            p = pathlib.Path(item[0])
#            source = pathlib.Path(*p.parts[:-1])
#            name = p.stem.split('_')[:-1]
#            prefix = '_'.join(name)
...
#        exit(0)
#
##        self.train_negative_list_pre = [(x, y) for (x, y) in self.negatives_list if int(x.stem[:4]) < val_year]
##        self.val_negative_list_pre = [(x, y) for (x, y) in self.negatives_list if int(x.stem[:4]) == val_year]
##        self.test_negative_list_pre = [(x, y) for (x, y) in self.negatives_list if int(x.stem[:4]) == test_year]
##
##        self.train_negative_list = self.train_negative_list_pre[:(len(self.train_positive_list)*neg_pos_ratio)]
##        self.val_negative_list = self.val_negative_list_pre[:(len(self.val_positive_list)*neg_pos_ratio)]
##        self.test_negative_list = self.test_negative_list_pre[:(len(self.test_positive_list)*neg_pos_ratio)]
